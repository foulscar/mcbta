...
resource "aws_route53_record" "bta_api" {
  ...
  alias {
    ...
    name                   = aws_apigatewayv2_domain_name.bta.domain_name_configuration[0].target_domain_name
    zone_id                = aws_apigatewayv2_domain_name.bta.domain_name_configuration[0].hosted_zone_id
  }
}
